...
export default {
  ...
  methods: {
    ...
    volumeEvent() {
      ...
      this.vvolumeBar.onclick = e => {
        this.volumeMoveEventCall(e)
      }
    },
    fullScreenEvent() {
    ...
    processBarEvent() {
      ...
      this.vprocess.onmousedown = e => {
        ...
        debugger
        // this.processmove()
        //  let offset = e.offsetX / this.vprocess.offsetWidth
        console.log('current', this.video.duration, this.offsetX)
        this.video.currentTime = this.video.duration * this.offsetX
      }
    ...
    volumeMove() {
      this.vvolumePoint.onmousedown = e => {
        e.preventDefault()
        e.stopPropagation()
        this.clientVolumeY = e.clientY - this.vvolumePoint.offsetTop
    ...
    movedown(e) {
      this.clientX = e.clientX - this.vpoint.offsetLeft
