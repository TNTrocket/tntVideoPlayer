...
export default {
  ...
  mounted() {
    ...
    this.vprocess = this.warpper.querySelector('.vprocess')
    this.uploadCss()
    this.initEvent()
    this.initTxt()
    // if (Hls.isSupported()) {
  ...
  methods: {
    ...
    update() {
      ...
      this.lineWidth = (this.video.currentTime / this.video.duration)* this.vprocess.clientWidth
    },
    initTxt() {
