  ...
  methods: {
    initEvent() {
      ...
      this.vvolumePoint.onmousedown = e => {
        ...
        this.vvolumeBar.onmousemove = e => {
          let disY = e.clientY - this.volumeY
          console.log('lineVolumeHeight', this.lineVolumeHeight)
          if (this.lineVolumeHeight < 0) return
          if (this.lineVolumeHeight > this.vvolumeBar.clientHeight) return
          this.lineVolumeHeight += disY
          this.volumeY = e.clientY
        }
        this.vvolumeBar.onmouseup = () => {
          this.vvolumeBar.onmousemove = null
          this.vvolumeBar.onmouseup = null
        }
      }
