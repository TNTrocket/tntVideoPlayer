...
export default {
  ...
  methods: {
    ...
    processmove(e) {
      ...
      console.log('ClientWidth', this.lineWidth, this.vprocess.clientWidth)
      if (this.lineWidth < 0) {
        　console.log('over 0=====')
        this.lineWidth = 0
        this.clientX = 0
      ...
      if (this.lineWidth > this.vprocess.clientWidth) {
        console.log('overClientWidth')
        this.lineWidth = this.vprocess.clientWidth
      } else {
         console.log('noover ===', this.clientX)
        // this.lineWidth = this.vprocess.clientWidth
        this.clientX = e.clientX
      }
      console.log('disX', disX, e.clientX)
